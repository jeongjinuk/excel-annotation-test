...
public class AverageFormula implements FormulaTemplate<TestDto> {
    ...
    public void render(AdapterSheet sheet, int rowIndex, Map<String, Integer> fieldNameWithColumnIndexMap) {
        Cell cell = sheet.getCell(rowIndex, fieldNameWithColumnIndexMap.get("field2"));
        ...
        String formula = String.format("=AVERAGE(%s:%s)", address1, address2);
